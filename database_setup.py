...
class User(Base):
    ...
    __tablename__ = "users"
     ...
     # the id from Google is to big to be stored in an Integer
...
if __name__ == '__main__':
    ...
    session.add(Category(name="Action"))
    session.add(Category(name="Adventure"))
    session.add(Category(name="Comedy"))
    session.add(Category(name="Crime & Gangster"))
    session.add(Category(name="Drama"))
    session.add(Category(name="Horror"))
    session.add(Category(name="Musicals"))
    session.add(Category(name="Science Fiction"))
    session.add(Category(name="War"))
